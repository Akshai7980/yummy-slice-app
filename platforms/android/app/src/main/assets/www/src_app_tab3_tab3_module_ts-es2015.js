...
/* harmony import */ var swiper_swiper_bundle_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! swiper/swiper-bundle.css */ 45353);
/* harmony import */ var _service_controller_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/controller.service */ 26110);
/* harmony import */ var _service_storage_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../service/storage.service */ 55813);
...
let Tab3Page = class Tab3Page {
    constructor(crud, control, storage) {
        this.crud = crud;
    ...
    getCurrentUser() {
        this.control.fireauth.onAuthStateChanged((user) => {
            if (user != null) {
    ...
    sendCartLogs(params) {
        return this.crud.ngFirestore.collection('userCart').add(params).then((res) => {
    ...
    buyNow(p) {
        ...
        return this.crud.ngFirestore.collection('userBuyNowList').add(p).then((res) => {
    ...
    sendWishListLog(params) {
        return this.crud.ngFirestore.collection('userWishList').add(params).then((res) => {
