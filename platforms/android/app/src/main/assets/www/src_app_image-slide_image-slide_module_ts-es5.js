  ...
  (self["webpackChunkYummySlice"] = self["webpackChunkYummySlice"] || []).push([["src_app_image-slide_image-slide_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ImageSlidePageRoutingModule": function ImageSlidePageRoutingModule() {
          return (
            /* binding */
            _ImageSlidePageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _image_slide_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./image-slide.page */
      15932);
      ...
      var _ImageSlidePageRoutingModule = function ImageSlidePageRoutingModule() {
        _classCallCheck(this, ImageSlidePageRoutingModule);
      };

      _ImageSlidePageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ImageSlidePageModule": function ImageSlidePageModule() {
          return (
            /* binding */
            _ImageSlidePageModule
          );
        }
        /* harmony export */
      ...
      var _image_slide_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./image-slide-routing.module */
      53842);
      /* harmony import */


      var _image_slide_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./image-slide.page */
      15932);

      var _ImageSlidePageModule = function ImageSlidePageModule() {
        _classCallCheck(this, ImageSlidePageModule);
      };

      _ImageSlidePageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule, _image_slide_routing_module__WEBPACK_IMPORTED_MODULE_0__.ImageSlidePageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ImageSlidePage": function ImageSlidePage() {
          return (
            /* binding */
            _ImageSlidePage
          );
      ...
      var _raw_loader_image_slide_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./image-slide.page.html */
      44382);
      /* harmony import */


      var _image_slide_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./image-slide.page.scss */
      72791);
      /* harmony import */
      ...
      var _ImageSlidePage = /*#__PURE__*/function () {
        function ImageSlidePage(device, control, crud) {
          _classCallCheck(this, ImageSlidePage);
        ...
        _createClass(ImageSlidePage, [{
          key: "ngOnInit",
          value: function ngOnInit() {// console.log('Device UUID is: ' + this.device.uuid);
          ...
          key: "userDeviceDetails",
          value: function userDeviceDetails() {
            if (this.control.platform.is("capacitor" || 0)) {
              this.deviceDetails.uuid = this.device.uuid;
              this.deviceDetails.cordova = this.device.cordova; // this.deviceDetails.isVirtual = this.device.isVirtual;
              ...
              this.deviceDetails.version = this.device.version; // this.deviceDetails.time = this.device.version;
              // this.deviceDetails = {
              ...
              this.crud.userDeviceDetails(this.deviceDetails).then(function () {})["catch"](function (err) {
                console.log(err);
              });
            } else {
              console.log('This is a web view');
              this.crud.userDeviceDetails(this.webDetails).then(function () {})["catch"](function (err) {
                console.log(err);
              });
            }
      ...
      _ImageSlidePage.ctorParameters = function () {
        return [{
      ...
      _ImageSlidePage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
...
//# sourceMappingURL=src_app_image-slide_image-slide_module_ts-es5.js.map