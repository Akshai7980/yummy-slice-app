(function () {
  ...
  (self["webpackChunkYummySlice"] = self["webpackChunkYummySlice"] || []).push([["common"], {
    /***/
    6633:
    /*!*********************************************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        ...
        /* harmony export */
        "CrudService": function CrudService() {
          return (
            /* binding */
            _CrudService
          );
      ...
      var _CrudService = /*#__PURE__*/function () {
        function CrudService(ngFirestore) {
        ...
        _createClass(CrudService, [{
          ...
          value: function userDeviceDetails(device) {
      ...
      _CrudService.ctorParameters = function () {
        return [{
          type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.AngularFirestore
        }];
      };

      _CrudService = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.Injectable)({
        providedIn: 'root'
      })], _CrudService);
      /***/
    },
