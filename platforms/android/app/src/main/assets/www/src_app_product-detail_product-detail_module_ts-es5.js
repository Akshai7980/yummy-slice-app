(function () {
  ...
  (self["webpackChunkYummySlice"] = self["webpackChunkYummySlice"] || []).push([["src_app_product-detail_product-detail_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_badge_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! !raw-loader!./badge.component.html */
      36314);
      /* harmony import */


      var _badge_component_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      _BadgeComponent.ctorParameters = function () {
        return [];
      };

      _BadgeComponent.propDecorators = {
        icon: [{
      ...
      _BadgeComponent = (0, tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.Component)({
        selector: 'app-badge',
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_button_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      ...
      _ButtonComponent.ctorParameters = function () {
        return [];
      };

      _ButtonComponent = (0, tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_3__.Component)({
        selector: 'app-button',
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "ProductDetailPageRoutingModule": function ProductDetailPageRoutingModule() {
          return (
            /* binding */
            _ProductDetailPageRoutingModule
          );
        }
        /* harmony export */
      ...
      var _ProductDetailPageRoutingModule = function ProductDetailPageRoutingModule() {
        _classCallCheck(this, ProductDetailPageRoutingModule);
      };

      _ProductDetailPageRoutingModule = (0, tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _product_detail_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./product-detail-routing.module */
      71481);
      /* harmony import */


      var _product_detail_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./product-detail.page */
      96055);
      /* harmony import */


      var _components_badge_badge_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _ProductDetailPageModule = function ProductDetailPageModule() {
        _classCallCheck(this, ProductDetailPageModule);
      };

      _ProductDetailPageModule = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_5__.NgModule)({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_6__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_7__.FormsModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_8__.IonicModule, _product_detail_routing_module__WEBPACK_IMPORTED_MODULE_0__.ProductDetailPageRoutingModule],
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _ProductDetailPage = /*#__PURE__*/function () {
        function ProductDetailPage(control, storage, crud) {
          var _this = this;
          ...
          this.control.route.queryParams.subscribe(function (params) {
            if (_this.control.router.getCurrentNavigation().extras.state) {
              _this.productDetails = _this.control.router.getCurrentNavigation().extras.state.product;
              console.log('productDetails:', _this.productDetails);
            }
          });
        }
        ...
        _createClass(ProductDetailPage, [{
          ...
          value: function addItemToCart() {
            ...
            this.crud.ngFirestore.collection('userCart').add(cartitem).then(function (res) {
      ...
      _ProductDetailPage = (0, tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<div class=\"badge\">\n    <ion-icon [name]=\"icon\"></ion-icon> {{text}}\n</div>";
      /***/
    },
